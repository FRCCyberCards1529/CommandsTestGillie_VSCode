...
//								else{
									...
									Robot.kArmSubsystem.ClimbMotor.set(ControlMode.PercentOutput, -m_oi.Operator.getRawAxis(1)*0.50);
									Robot.kArmSubsystem.ElevatorMotor.set(ControlMode.PercentOutput, -m_oi.Operator.getRawAxis(1)*0.50);
